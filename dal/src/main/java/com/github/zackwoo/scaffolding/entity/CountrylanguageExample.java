...
public class CountrylanguageExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andMap(java.util.Map<String, Object> map) {
            if (map.containsKey("CountrycodeEqualTo")){
                 andCountrycodeEqualTo((String) map.get("CountrycodeEqualTo"));
            }
            if (map.containsKey("LanguageEqualTo")){
                 andLanguageEqualTo((String) map.get("LanguageEqualTo"));
            }
            if (map.containsKey("IsofficialEqualTo")){
                 andIsofficialEqualTo((String) map.get("IsofficialEqualTo"));
            }
            if (map.containsKey("PercentageEqualTo")){
                 andPercentageEqualTo((Double) map.get("PercentageEqualTo"));
            }
            return this;
        }
    }
