...
public class CountryExample {
     ...
     * This class corresponds to the database table COUNTRY
     *
     * @mbg.generated do_not_delete_during_merge Sat Apr 15 10:37:50 CST 2017
     */
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andMap(java.util.Map<String, Object> map) {
            if (map.containsKey("CodeEqualTo")){
                 andCodeEqualTo((String) map.get("CodeEqualTo"));
            }
            if (map.containsKey("NameEqualTo")){
                 andNameEqualTo((String) map.get("NameEqualTo"));
            }
            if (map.containsKey("ContinentEqualTo")){
                 andContinentEqualTo((String) map.get("ContinentEqualTo"));
            }
            if (map.containsKey("RegionEqualTo")){
                 andRegionEqualTo((String) map.get("RegionEqualTo"));
            }
            if (map.containsKey("SurfaceareaEqualTo")){
                 andSurfaceareaEqualTo((Double) map.get("SurfaceareaEqualTo"));
            }
            if (map.containsKey("IndepyearEqualTo")){
                 andIndepyearEqualTo((Short) map.get("IndepyearEqualTo"));
            }
            if (map.containsKey("PopulationEqualTo")){
                 andPopulationEqualTo((Integer) map.get("PopulationEqualTo"));
            }
            if (map.containsKey("LifeexpectancyEqualTo")){
                 andLifeexpectancyEqualTo((Double) map.get("LifeexpectancyEqualTo"));
            }
            if (map.containsKey("GnpEqualTo")){
                 andGnpEqualTo((Double) map.get("GnpEqualTo"));
            }
            if (map.containsKey("GnpoldEqualTo")){
                 andGnpoldEqualTo((Double) map.get("GnpoldEqualTo"));
            }
            if (map.containsKey("LocalnameEqualTo")){
                 andLocalnameEqualTo((String) map.get("LocalnameEqualTo"));
            }
            if (map.containsKey("GovernmentformEqualTo")){
                 andGovernmentformEqualTo((String) map.get("GovernmentformEqualTo"));
            }
            if (map.containsKey("HeadofstateEqualTo")){
                 andHeadofstateEqualTo((String) map.get("HeadofstateEqualTo"));
            }
            if (map.containsKey("CapitalEqualTo")){
                 andCapitalEqualTo((Integer) map.get("CapitalEqualTo"));
            }
            if (map.containsKey("Code2EqualTo")){
                 andCode2EqualTo((String) map.get("Code2EqualTo"));
            }
            return this;
        }
    }
